#!/bin/bash
#SBATCH --job-name="stream 64t batcat"
#SBATCH --exclusive
#SBATCH --mem=125G
##SBATCH -w batcat
#SBATCH --time=40:00:00
#SBATCH --partition=p_hpca4se
#SBATCH -o /home/jlenis/numa_benchmark/outputs/stream/batcat/64/stream_regular_64t_batcat_%j.log
#SBATCH -C "Opteron"
...
output_path="/home/jlenis/numa_benchmark/outputs/stream/batcat/$OMP_NUM_THREADS"
