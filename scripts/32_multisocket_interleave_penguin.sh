#!/bin/bash
#SBATCH --job-name="interleave 32 penguin"
#SBATCH --exclusive
#SBATCH --mem=125G
#SBATCH -w penguin
#SBATCH --time=40:00:00
#SBATCH --partition=p_hpca4se
#SBATCH -o /home/jlenis/numa_benchmark/outputs/stream/penguin/32/interleave_32t_penguin_%j.log
##SBATCH -C "Opteron"
...
utput_path="/home/jlenis/numa_benchmark/outputs/stream/penguin/32t"
	 			                     end=$SECONDS
         			                     runtime=$((end-start2))
			                     done
                                     fi
