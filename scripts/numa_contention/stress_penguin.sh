#!/bin/bash
#SBATCH --job-name="stress penguin"
#SBATCH --exclusive
#SBATCH --mem=125G
#SBATCH -w penguin
#SBATCH --time=40:00:00
#SBATCH --partition=p_hpca4se
#SBATCH -o /home/jlenis/numa_benchmark/outputs/numa_contention/penguin/stress_%j.log
...
output_path="/home/jlenis/numa_benchmark/outputs/numa_contention/penguin"
