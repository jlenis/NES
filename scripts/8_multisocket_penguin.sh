#!/bin/bash
#SBATCH --job-name="membind 8t penguin"
#SBATCH --exclusive
#SBATCH --mem=125G
#SBATCH -w penguin
#SBATCH --time=40:00:00
#SBATCH --partition=p_hpca4se
#SBATCH -o /home/jlenis/numa_benchmark/scripts/stream/membind_8t_penguin_%j.log
##SBATCH -o /home/jlenis/numa_benchmark/outputs/stream/penguin/8/membind_8t_penguin_%j.log
...
output_path="/home/jlenis/numa_benchmark/outputs/stream/penguin/$OMP_NUM_THREADS/$size"
